...
namespace SonarRESTOCK
{
    public static class AES
    {

        private static string password = "SonarRESTOCK";
        ...
        public static string retrunpw()
        {
            return Reverse(password).ToUpper();
        }
        ...
        public static string Encrypt(string text)
        {
            ...
            byte[] encryptedBytes = null;
            byte[] passwordBytes = Encoding.UTF8.GetBytes(retrunpw());
